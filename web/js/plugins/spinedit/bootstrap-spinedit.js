...
!function ($) {
	...
	$(template).each(function (i,x) {
        ...
        template.find('#spinedit-increase').mousehold($.proxy(this.increase, this));
        template.find('#spinedit-decrease').mousehold($.proxy(this.decrease, this));
    ...
    DRPGlobal.template =                           
	'<span class="input-group-btn"><button id="spinedit-increase" class="spinedit btn btn-white"><i class="fa fa-chevron-up"/></button>' +
	'<button id="spinedit-decrease" class="spinedit btn btn-white"><i class="fa fa-chevron-down"></i>' +
	'</button></span>';
