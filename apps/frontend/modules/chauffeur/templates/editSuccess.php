...
<div class="wrapper wrapper-content animated fadeInRight">
    <div id="tpltEdtHrchy" class="hidden">
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong><?php echo __('Modifier un chauffeur'); ?></strong>
            </li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo __('Formulaire de modification d\'un chauffeur'); ?></h5>
                </div>
                <div class="ibox-content">
                    <form method="POST" action="<?php echo url_for(array('sf_route' => 'referentiels-chauffeur-update')) ?>" id="formEdit" class="form-horizontal">
                        <input type="hidden" name="idChauffeur" value="<?php echo $ref_chauffeur->getIdChauffeur() ?>"/> 
                        <?php include_partial('form', array('ref_chauffeur' => $ref_chauffeur, 'transporteurs' => $transporteurs)) ?>
