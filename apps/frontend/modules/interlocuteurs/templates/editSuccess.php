<div class="wrapper wrapper-content animated fadeInRight">
    <div id="tpltEdtHrchy" class="hidden">
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong><?php echo __('Modifier un interlocuteur'); ?></strong>
            </li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo __('Formulaire de modification d\'un interlocuteur'); ?></h5>
                </div>
                <div class="ibox-content">
                    <form method="POST" action="<?php echo url_for(array('sf_route' => 'referentiels-interlocuteur-update')) ?>" id="formEdit" class="form-horizontal">
                        <input type="hidden" name="id" value="<?php echo $interlocuteur->getId() ?>"/> 
                       <?php include_partial('form', array('interlocuteur' => $interlocuteur, "emplacements" => $emplacements)) ?>
